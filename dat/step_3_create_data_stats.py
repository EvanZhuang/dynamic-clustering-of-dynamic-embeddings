...
# Change this to the number of characters in the file names
# that should be matched to the timeslice prefix.
...
# Change this to a list of query words you would like
# the algorithm to print descriptive statistics of
# (i.e. a trajectory of the learned dynamic embeddings)
...
def count_words(split):
    ...
    for t, i in enumerate(dat_stats['T_bins']):
        dat_files = [f for f in files if int(
